...
static void DebugAction_Util_Warp_Warp(u8 taskId)
{
    ...
    ConvertIntToDecimalStringN(gStringVar2, 35 -1, STR_CONV_MODE_LEADING_ZEROS, 2);
...
static void DebugAction_Util_Warp_SelectMapGroup(u8 taskId)
{
    if (gMain.newKeys & ((0x0010 | 0x0020 | 0x0040 | 0x0080)))
    {
        ...
        if(gMain.newKeys & 0x0040)
        {
            ...
            if(gTasks[taskId].data[3] > 35 -1)
                gTasks[taskId].data[3] = 35 -1;
        }
...
static void DebugAction_Flags_ToggleFlyFlags(u8 taskId)
{
    ...
    if(FlagGet((((0x500 + 864 - 1) + 1) + 0x48)))
        ...
        PlaySE(2);
    FlagToggle((((0x500 + 864 - 1) + 1) + 0xF));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x10));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x11));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x12));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x13));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x14));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x15));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x16));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x17));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x18));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x19));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x1A));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x1B));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x1C));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x1D));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x1E));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x54));
    FlagToggle((((0x500 + 864 - 1) + 1) + 0x48));
}
...
static void DebugAction_Give_Item_SelectId(u8 taskId)
{
    if (gMain.newKeys & ((0x0010 | 0x0020 | 0x0040 | 0x0080)))
    {
        ...
        {
            gTasks[taskId].data[3] += sPowersOfTen[gTasks[taskId].data[4]];
            if(gTasks[taskId].data[3] >= 607)
                gTasks[taskId].data[3] = 607 - 1;
        }
        if(gMain.newKeys & 0x0080)
        {
            gTasks[taskId].data[3] -= sPowersOfTen[gTasks[taskId].data[4]];
...
static void DebugAction_Give_PokemonSimple(u8 taskId)
{
    ...
    LoadMonIconPalette(gTasks[taskId].data[3]);
        ...
        gTasks[taskId].data[6] = CreateMonIcon(gTasks[taskId].data[3], SpriteCB_MonIcon, 210, 50, 4, 0);
...
static void DebugAction_Give_Pokemon_SelectId(u8 taskId)
{
    if (gMain.newKeys & ((0x0010 | 0x0020 | 0x0040 | 0x0080)))
    {
        ...
        if(gMain.newKeys & 0x0040)
        {
            ...
            if(gTasks[taskId].data[3] >= 898 + 314 + 1 - 1)
                gTasks[taskId].data[3] = 898 + 314 + 1 - 2;
        }
        if(gMain.newKeys & 0x0080)
        {
            gTasks[taskId].data[3] -= sPowersOfTen[gTasks[taskId].data[4]];
...
static void DebugAction_Give_Pokemon_Move(u8 taskId)
{
    if (gMain.newKeys & ((0x0010 | 0x0020 | 0x0040 | 0x0080)))
    {
        ...
        {
            gTasks[taskId].data[3] += sPowersOfTen[gTasks[taskId].data[4]];
            if(gTasks[taskId].data[3] > 796)
                gTasks[taskId].data[3] = 796;
        }
        if(gMain.newKeys & 0x0080)
        {
            gTasks[taskId].data[3] -= sPowersOfTen[gTasks[taskId].data[4]];
...
# 2280 "src/debug.c"
    ...
    for (i = 0; i < 4; i++)
    {
        if (moves[i] == 0 || moves[i] == 0xFF || moves[i] > 796)
            continue;
