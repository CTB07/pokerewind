...
static const TaskFunc sPhase1_Tasks[43] =
{
    [0 ... 43 - 1] = &Phase1Task_TransitionAll
};

static const TaskFunc sPhase2_Tasks[43] =
{
    [0] = Phase2Task_Blur,
    [1] = Phase2Task_Swirl,
...
static void Phase2Task_AnnoyingOrange(u8 taskId)
{
   while (sPhase2_AnnoyingOrange_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
