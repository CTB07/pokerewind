...
static const u8 sMapName_HomegeTown[] = _("HOMEGE TOWN");
static const u8 sMapName_RewindRoute1[] = _("ROUTE 1");
...
const struct RegionMapLocation gRegionMapEntries[] = {
    ...
    [0xD5] = {0, 0, 1, 1, sMapName_HomegeTown},
    [0xD6] = {0, 0, 1, 1, sMapName_RewindRoute1}
};
...
static u16 CorrectSpecialMapSecId_Internal(u16 mapSecId)
{
    ...
    for (i = 0; sRegionMap_SpecialPlaceLocations[i][0] != 0xD7; i++)
    {
...
static void TryCreateRedOutlineFlyDestIcons(void)
{
    ...
    for (i = 0; sRedOutlineFlyDestinations[i][1] != 0xD7; i++)
    {
