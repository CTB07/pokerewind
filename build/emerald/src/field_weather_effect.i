...
# 362 "src/field_weather_effect.c"
...
# 556 "src/field_weather_effect.c"
...
# 766 "src/field_weather_effect.c"
...
# 903 "src/field_weather_effect.c"
static bool8 CreateSnowflakeSprite(void)
{
...
# 1018 "src/field_weather_effect.c"
void Thunderstorm_InitVars(void)
{
    gWeatherPtr->initStep = 0;
    gWeatherPtr->weatherGfxLoaded = 0;
...
# 1699 "src/field_weather_effect.c"
...
# 1908 "src/field_weather_effect.c"
...
# 2103 "src/field_weather_effect.c"
static void CreateSandstormSprites(void)
{
    u16 i;
    u8 spriteId;
...
# 2217 "src/field_weather_effect.c"
void Shade_InitVars(void)
{
    gWeatherPtr->initStep = 0;
    gWeatherPtr->gammaTargetIndex = 3;
...
# 2408 "src/field_weather_effect.c"
