...
u8 BattleSetup_GetTerrainId(void)
{
    ...
    case 4:
        ...
        {
            if (gSaveBlock1Ptr->location.mapGroup == ((4 | (1 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((4 | (1 << 8)) & 0xFF))
            {
                return 10;
            }
            else
...
static u16 GetSumOfPlayerPartyLevel(u8 numMons)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        if (species != 898 + 314 + 1 && species != 0 && GetMonData(&gPlayerParty[i], 57) != 0)
        {
