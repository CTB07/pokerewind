...
static void Select_CreateMonSprite(void)
{
    ...
    sFactorySelectScreen->monPics[1].monSpriteId = CreateMonPicSprite(species, otId, personality, 1, 88, 32, 15, 0xFFFF);
    ...
    for (i = 0; i < 3; i++)
    {
        for (j = 0; j < 6; j++)
        {
            if (sFactorySelectScreen->mons[j].selectedId == i + 1)
            {
                ...
                sFactorySelectScreen->monPics[i].monSpriteId = CreateMonPicSprite(species, otId, personality, 1, (i * 72) + 16, 32, i + 13, 0xFFFF);
...
static void Swap_ShowSummaryMonSprite(void)
{
    ...
    sFactorySwapScreen->monPic.monSpriteId = CreateMonPicSprite(species, personality, otId, 1, 88, 32, 15, 0xFFFF);
...
static void Swap_CreateMonSprite(void)
{
    ...
    sFactorySwapScreen->monPic.monSpriteId = CreateMonPicSprite(species, otId, personality, 1, 88, 32, 15, 0xFFFF);
    gSprites[sFactorySwapScreen->monPic.monSpriteId].centerToCornerVecX = 0;
    gSprites[sFactorySwapScreen->monPic.monSpriteId].centerToCornerVecY = 0;
