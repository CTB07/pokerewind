...
static u8 GetForcedMovementByMetatileBehavior(void)
{
    ...
    if (!(gPlayerAvatar.flags & (1 << 5)))
    {
        ...
        for (i = 0; i < (sizeof(sForcedMovementTestFuncs)/sizeof(*(sForcedMovementTestFuncs))); i++)
        {
...
# 1728 "src/field_player_avatar.c"
...
# 2120 "src/field_player_avatar.c"
