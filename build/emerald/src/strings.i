...
const u8 gText_DefaultNameStu[] = _("Male");
const u8 gText_DefaultNameMilton[] = _("Chad");
const u8 gText_DefaultNameTom[] = _("Logan");
const u8 gText_DefaultNameKenny[] = _("Walmart");
const u8 gText_DefaultNameReid[] = _("Conk");
const u8 gText_DefaultNameJude[] = _("DICKS");
const u8 gText_DefaultNameJaxson[] = _("s-sir");
const u8 gText_DefaultNameEaston[] = _("YouTube");
const u8 gText_DefaultNameWalker[] = _("uwu…");
const u8 gText_DefaultNameTeru[] = _("Bichael");
const u8 gText_DefaultNameJohnny[] = _("ur mom");
const u8 gText_DefaultNameBrett[] = _("my dude");
const u8 gText_DefaultNameSeth[] = _("A");
const u8 gText_DefaultNameTerry[] = _("Pissboy");
const u8 gText_DefaultNameCasey[] = _("Jeff");
const u8 gText_DefaultNameDarren[] = _("xGaMeRx");
const u8 gText_DefaultNameLandon[] = _("Sneed");
const u8 gText_DefaultNameCollin[] = _("Reddit");
const u8 gText_DefaultNameStanley[] = _("Jontron");
const u8 gText_DefaultNameQuincy[] = _("Ponyboy");
const u8 gText_DefaultNameKimmy[] = _("Female");
const u8 gText_DefaultNameTiara[] = _("Stacey");
const u8 gText_DefaultNameBella[] = _("Susan");
const u8 gText_DefaultNameJayla[] = _("BestBuy");
const u8 gText_DefaultNameAllie[] = _("Bepsi");
const u8 gText_DefaultNameLianna[] = _("ASS");
const u8 gText_DefaultNameSara[] = _("mommy");
const u8 gText_DefaultNameMonica[] = _("Vaping");
const u8 gText_DefaultNameCamila[] = _("Nutella");
const u8 gText_DefaultNameAubree[] = _("nya?");
const u8 gText_DefaultNameRuthie[] = _("Rawr XD");
const u8 gText_DefaultNameHazel[] = _("fucker");
const u8 gText_DefaultNameNadine[] = _("Frisk");
const u8 gText_DefaultNameTanja[] = _("▶");
const u8 gText_DefaultNameYasmin[] = _("egg");
const u8 gText_DefaultNameNicola[] = _("fart");
const u8 gText_DefaultNameLillie[] = _("Smosh");
const u8 gText_DefaultNameTerra[] = _("iCarly");
const u8 gText_DefaultNameLucy[] = _("Bagina");
const u8 gText_DefaultNameHalie[] = _("Karen");
const u8 gText_ThisIsAPokemon[] = _("But what IS a “Pokémon?”{PAUSE 96}\p");
