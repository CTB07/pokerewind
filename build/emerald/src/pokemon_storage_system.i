...
static u16 sub_80CC124(u16 species, u32 personality)
{
    ...
    var = 16 * i;
    CpuSet(GetMonIconTiles(species, personality), (void*)((0x6000000 + 0x10000)) + var * 32, 0x04000000 | ((0x200)/(32/8) & 0x1FFFFF));
...
static void sub_80CE350(u16 *moves)
{
    ...
    {
        if (gUnknown_0857B9A4[i].mapGroup == 35
...
static bool8 sub_80CFB44(void)
{
    if (sPSSData->cursorMonSpecies == 898 + 314 + 1)
        return 0;
