...
int GetUnionRoomTradeMessageId(struct GFtgtGnameSub rfuPlayer, struct GFtgtGnameSub rfuPartner, u16 playerSpecies2, u16 partnerSpecies, u8 requestedType, u16 playerSpecies, u8 isObedientBitSet)
{
    ...
    if (playerSpecies2 == 898 + 314 + 1 && playerSpecies2 != partnerSpecies)
    {
        return 3;
    }
...
static bool8 AnimateTradeSequenceCable(void)
{
    ...
    case 10:
        ...
        if (sTradeData->monSpecies[0] != 898 + 314 + 1)
        {
    ...
    case 65:
        ...
        {
            HandleLoadSpecialPokePic(&gMonFrontPicTable[sTradeData->monSpecies[1]], gMonSpritesGfxPtr->sprites.ptr[3], sTradeData->monSpecies[1], sTradeData->monPersonalities[1]);
            sTradeData->state++;
        }
        break;
    case 66:
