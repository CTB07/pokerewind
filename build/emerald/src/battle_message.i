...
const u8 *const gBattleStringsTable[570] =
{
    ...
    [565 - 12] = sText_PlayerLostToEnemyTrainer,
    [566 - 12] = sText_PlayerPaidPrizeMoney,
    [567 - 12] = sText_BattlerAbilityRaisedStatDrastically,
    [568 - 12] = sText_NoFucksEnters,
    [569 - 12] = sText_OppositeDayEnters,
...
void BufferStringBattle(u16 stringID)
{
    ...
    case 3:
        ...
        break;
    case 4:
        if (gBattleMsgDataPtr->currentMove >= 796)
    ...
    while (*src != 0xFF)
    {
        ...
        if (*src == 0xFD)
        {
            ...
            case 0x14:
                ...
                break;
            case 0x15:
                if (gBattleMsgDataPtr->originallyUsedMove >= 796)
                    toCpy = sATypeMove_Table[gBattleStruct->stringMoveType];
                else
