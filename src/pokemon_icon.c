...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_KURZEQUAK] = gMonIcon_Kurzequak,
    ...
    [SPECIES_INNERLING] = gMonIcon_Innerling,
    ...
    [SPECIES_FONDAUNT] = gMonIcon_Fondaunt,
    [SPECIES_FONDAUNT_BUSTED] = gMonIcon_FondauntBusted,
    [SPECIES_ROB3R] = gMonIcon_Rob3R,
    [SPECIES_SKORCHOP] = gMonIcon_Skorchop,
    [SPECIES_CUBEAST] = gMonIcon_Cubeast,
    [SPECIES_BEASTUNT] = gMonIcon_Beastunt,
    [SPECIES_ASTLURE] = gMonIcon_Astlure,
    [SPECIES_HOOTUBE] = gMonIcon_Hootube,
    [SPECIES_CHANNOWL] = gMonIcon_Channowl,
    [SPECIES_PUPPARMY] = gMonIcon_Pupparmy,
    [SPECIES_FANDAM] = gMonIcon_Fandam,
    [SPECIES_PEWCO] = gMonIcon_Pewco,
    [SPECIES_PANZERAGE] = gMonIcon_Panzerage,
    [SPECIES_SQUEEGEE] = gMonIcon_Squeegee,
    [SPECIES_WHYTEEPEE] = gMonIcon_Whyteepee,
    [SPECIES_SHIPOSTAR] = gMonIcon_Shipostar,
    [SPECIES_MUSTELIT] = gMonIcon_Mustelit,
    [SPECIES_CAPENSEAR] = gMonIcon_Capensear,
    [SPECIES_SMOGARETTE] = gMonIcon_Smogarette,
    [SPECIES_METOXIC] = gMonIcon_Metoxic,
    ...
    [SPECIES_LYSALCHI] = gMonIcon_Lysalchi,
    [SPECIES_DRACCOON] = gMonIcon_Draccoon,
    ...
    [SPECIES_DUYUKNO] = gMonIcon_Duyukno,
    [SPECIES_HALFIST] = gMonIcon_Halfist,
    [SPECIES_INEVITON] = gMonIcon_Ineviton,
    [SPECIES_BAYPUP] = gMonIcon_Baypup,
    [SPECIES_SHARPARENT] = gMonIcon_Sharparent,
    [SPECIES_SHARPARENT_FEMALE] = gMonIcon_SharparentF,
    [SPECIES_MEGRANDON] = gMonIcon_Megrandon,
    [SPECIES_MEGRANDON_FEMALE] = gMonIcon_MegrandonF,
    [SPECIES_SINDIVIDUA] = gMonIcon_Sindividua,
    [SPECIES_POWERRUPT] = gMonIcon_Powerrupt,
    [SPECIES_BROYALTY] = gMonIcon_Broyalty,
    [SPECIES_PRIMOURN] = gMonIcon_Primourn,
    [SPECIES_MASCOT] = gMonIcon_Mascot,
    [SPECIES_MUNCHARLIE] = gMonIcon_Muncharlie,
    [SPECIES_FINGATOR] = gMonIcon_Fingator,
    [SPECIES_GARASITE] = gMonIcon_Garasite,
    [SPECIES_CUBBLE] = gMonIcon_Cubble,
    [SPECIES_PANDACHOO] = gMonIcon_Pandachoo,
    [SPECIES_GESUNDHA] = gMonIcon_Gesundha,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_GRUBFEED] = 0,
    [SPECIES_KWIZBEE] = 0,
    [SPECIES_COSMONARCH] = 0,
    [SPECIES_PAASTEL] = 0,
    [SPECIES_SHEEPASTRY] = 0,
    [SPECIES_TYPURR] = 0,
    [SPECIES_CALIKEY] = 0,
    [SPECIES_SPOOKIDS] = 0,
    [SPECIES_TOGETERROR] = 0,
    [SPECIES_BUBOZOA] = 0,
    [SPECIES_CHRYSAPOD] = 0,
    [SPECIES_ARGIGAMI] = 0,
    [SPECIES_DISPUTRAW] = 0,
    ...
    [SPECIES_PUPYRO] = 0,
    [SPECIES_PYRULPES] = 0,
    [SPECIES_KITSINICAL] = 0,
    [SPECIES_COMMUNYMPH] = 0,
    [SPECIES_MANTIFA] = 0,
    [SPECIES_HATCHAAL] = 5,
    [SPECIES_CRUSYGLE] = 5,
    [SPECIES_BUBBABE] = 0,
    ...
    [SPECIES_MUSTELIT] = 0,
    [SPECIES_CAPENSEAR] = 0,
    [SPECIES_SMOGARETTE] = 0,
    [SPECIES_METOXIC] = 0,
    [SPECIES_ILLUMARYD] = 0,
    [SPECIES_ENLIMINATI] = 0,
    [SPECIES_POSTLE] = 0,
    [SPECIES_HUSHBACK] = 0,
    [SPECIES_LYSALCHI] = 0,
    [SPECIES_DRACCOON] = 0,
    [SPECIES_VEGAVA] = 0,
    [SPECIES_GLUTTOCADO] = 0,
    [SPECIES_RANDOMAIL] = 0,
    [SPECIES_DEDLIVERY] = 0,
    [SPECIES_PLAYSTRIKE] = 0,
    [SPECIES_EXBULK] = 0,
    [SPECIES_TOUCHSPEED] = 0,
    [SPECIES_ZOUNO] = 0,
    [SPECIES_PHANESIS] = 0,
    [SPECIES_BIOSSIL] = 0,
    [SPECIES_VIRANCIENT] = 0,
    [SPECIES_EVECHO] = 0,
    [SPECIES_BARSONIST] = 0,
    [SPECIES_CHIPCHUNE] = 0,
    [SPECIES_ORCLASSTRA] = 0,
    [SPECIES_RELAQUA] = 0,
    [SPECIES_SQUEANIME] = 0,
    [SPECIES_ENIGMASH] = 0,
    [SPECIES_AIRPODON] = 0,
    ...
    [SPECIES_INEVITON] = 0,
    [SPECIES_BAYPUP] = 0,
    [SPECIES_SHARPARENT] = 0,
    [SPECIES_MEGRANDON] = 0,
    [SPECIES_SINDIVIDUA] = 0,
    [SPECIES_POWERRUPT] = 0,
    [SPECIES_BROYALTY] = 0,
    [SPECIES_PRIMOURN] = 0,
    [SPECIES_MASCOT] = 0,
    [SPECIES_MUNCHARLIE] = 0,
    [SPECIES_FINGATOR] = 0,
    [SPECIES_GARASITE] = 0,
    [SPECIES_CUBBLE] = 0,
    [SPECIES_PANDACHOO] = 0,
