...
static const struct TrainerMon sParty_Donald[] = {
    ...
    .iv = 100,
    .lvl = 24,
    .species = SPECIES_LAMPUPA,
    },
    {
    .iv = 100,
    .lvl = 24,
    .species = SPECIES_ELECREEP,
    }
};
