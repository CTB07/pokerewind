static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_REWIND_TOWN1 - 1] = {MAP_GROUP(REWIND_TOWN1), MAP_NUM(REWIND_TOWN1), 3, 14},
    [HEAL_LOCATION_HOMEGE_TOWN - 1] = {MAP_GROUP(HOMEGE_TOWN), MAP_NUM(HOMEGE_TOWN), 9, 14},
    [HEAL_LOCATION_ICOVALE_CITY - 1] = {MAP_GROUP(ICOVALE_CITY), MAP_NUM(ICOVALE_CITY), 0, 0},
};
