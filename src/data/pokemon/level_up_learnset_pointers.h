const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_KURZEQUAK] = sKurzequakLevelUpLearnset,
    ...
    [SPECIES_FLEXNAKE] = sFlexnakeLevelUpLearnset,
    [SPECIES_FLEXAIL] = sFlexailLevelUpLearnset,
    [SPECIES_ETIKUB] = sEtikubLevelUpLearnset,
    [SPECIES_DESMANTHER] = sDesmantherLevelUpLearnset,
    [SPECIES_SUPPORPOD] = sSupporpodLevelUpLearnset,
    [SPECIES_FLYPOD] = sFlypodLevelUpLearnset,
    [SPECIES_VEESEE] = sVeeseeLevelUpLearnset,
    [SPECIES_DRACORD] = sDracordLevelUpLearnset,
    [SPECIES_DONKRIME] = sDonkrimeLevelUpLearnset,
    [SPECIES_MAFIADASS] = sMafiadassLevelUpLearnset,
    [SPECIES_INNERLING] = sInnerlingLevelUpLearnset,
    [SPECIES_BRAIMATE] = sBraimateLevelUpLearnset,
    [SPECIES_CREWEBRAL] = sCrewebralLevelUpLearnset,
    [SPECIES_IMPVADER] = sImpvaderLevelUpLearnset,
    [SPECIES_EXTERESSUS] = sExteressusLevelUpLearnset,
    [SPECIES_ALSNOW] = sAlsnowLevelUpLearnset,
    [SPECIES_COOLLEM] = sCoollemLevelUpLearnset,
    [SPECIES_DARKORPSE] = sDarkorpseLevelUpLearnset,
    [SPECIES_FUNNESUS] = sFunnesusLevelUpLearnset,
    [SPECIES_PUPYRO] = sPupyroLevelUpLearnset,
    [SPECIES_PYRULPES] = sPyrulpesLevelUpLearnset,
    [SPECIES_KITSINICAL] = sKitsinicalLevelUpLearnset,
    [SPECIES_COMMUNYMPH] = sCommunymphLevelUpLearnset,
    [SPECIES_MANTIFA] = sMantifaLevelUpLearnset,
    [SPECIES_HATCHAAL] = sHatchaalLevelUpLearnset,
    [SPECIES_CRUSYGLE] = sCrusygleLevelUpLearnset,
    [SPECIES_BUBBABE] = sBubbabeLevelUpLearnset,
    [SPECIES_BUBBATH] = sBubbathLevelUpLearnset,
    [SPECIES_BUBBLUST] = sBubblustLevelUpLearnset,
    [SPECIES_FONDAUNT] = sFondauntLevelUpLearnset,
    [SPECIES_FONDAUNT_BUSTED] = sFondauntLevelUpLearnset,
    [SPECIES_ROB3R] = sROB3RLevelUpLearnset,
    [SPECIES_SKORCHOP] = sSkorchopLevelUpLearnset,
    [SPECIES_CUBEAST] = sCubeastLevelUpLearnset,
    [SPECIES_BEASTUNT] = sBeastuntLevelUpLearnset,
    [SPECIES_ASTLURE] = sAstlureLevelUpLearnset,
    [SPECIES_HOOTUBE] = sHootubeLevelUpLearnset,
    [SPECIES_CHANNOWL] = sChannowlLevelUpLearnset,
    [SPECIES_PUPPARMY] = sPupparmyLevelUpLearnset,
    [SPECIES_FANDAM] = sFandamLevelUpLearnset,
    [SPECIES_PEWCO] = sPewcoLevelUpLearnset,
    [SPECIES_PANZERAGE] = sPanzerageLevelUpLearnset,
    [SPECIES_SQUEEGEE] = sSqueegeeLevelUpLearnset,
    [SPECIES_WHYTEEPEE] = sWhyteepeeLevelUpLearnset,
    [SPECIES_SHIPOSTAR] = sShipostarLevelUpLearnset,
    [SPECIES_MUSTELIT] = sMustelitLevelUpLearnset,
    [SPECIES_CAPENSEAR] = sCapensearLevelUpLearnset,
    [SPECIES_SMOGARETTE] = sSmogaretteLevelUpLearnset,
    [SPECIES_METOXIC] = sMetoxicLevelUpLearnset,
    [SPECIES_ILLUMARYD] = sIllumarydLevelUpLearnset,
    [SPECIES_ENLIMINATI] = sEnliminatiLevelUpLearnset,
    [SPECIES_POSTLE] = sPostleLevelUpLearnset,
    [SPECIES_HUSHBACK] = sHushbackLevelUpLearnset,
    [SPECIES_LYSALCHI] = sLysalchiLevelUpLearnset,
    [SPECIES_DRACCOON] = sDraccoonLevelUpLearnset,
    [SPECIES_VEGAVA] = sVegavaLevelUpLearnset,
    [SPECIES_GLUTTOCADO] = sGluttocadoLevelUpLearnset,
    [SPECIES_RANDOMAIL] = sRandomailLevelUpLearnset,
    [SPECIES_DEDLIVERY] = sDedliveryLevelUpLearnset,
    [SPECIES_PLAYSTRIKE] = sPlaystrikeLevelUpLearnset,
    [SPECIES_EXBULK] = sExbulkLevelUpLearnset,
    [SPECIES_TOUCHSPEED] = sTouchspeedLevelUpLearnset,
    [SPECIES_ZOUNO] = sZounoLevelUpLearnset,
    [SPECIES_PHANESIS] = sPhanesisLevelUpLearnset,
    [SPECIES_BIOSSIL] = sBiossilLevelUpLearnset,
    [SPECIES_VIRANCIENT] = sVirancientLevelUpLearnset,
    [SPECIES_EVECHO] = sEvechoLevelUpLearnset,
    [SPECIES_BARSONIST] = sBarsonistLevelUpLearnset,
    [SPECIES_CHIPCHUNE] = sChipchuneLevelUpLearnset,
    [SPECIES_ORCLASSTRA] = sOrclasstraLevelUpLearnset,
    [SPECIES_RELAQUA] = sRelaquaLevelUpLearnset,
    [SPECIES_SQUEANIME] = sSqueanimeLevelUpLearnset,
    [SPECIES_ENIGMASH] = sEnigmashLevelUpLearnset,
    [SPECIES_AIRPODON] = sAirpodonLevelUpLearnset,
    [SPECIES_MIKOMODO] = sMikomodoLevelUpLearnset,
    [SPECIES_GOJIREC] = sGojirecLevelUpLearnset,
    [SPECIES_DUYUKNO] = sDuyuknoLevelUpLearnset,
    [SPECIES_HALFIST] = sHalfistLevelUpLearnset,
    [SPECIES_INEVITON] = sInevitonLevelUpLearnset,
    [SPECIES_BAYPUP] = sBaypupLevelUpLearnset,
    [SPECIES_SHARPARENT] = sSharparentLevelUpLearnset,
    [SPECIES_SHARPARENT_FEMALE] = sSharparentLevelUpLearnset,
    [SPECIES_MEGRANDON] = sMegrandonLevelUpLearnset,
    [SPECIES_MEGRANDON_FEMALE] = sMegrandonLevelUpLearnset,
    [SPECIES_SINDIVIDUA] = sSindividuaLevelUpLearnset,
    [SPECIES_POWERRUPT] = sPowerruptLevelUpLearnset,
    [SPECIES_BROYALTY] = sBroyaltyLevelUpLearnset,
    [SPECIES_PRIMOURN] = sPrimournLevelUpLearnset,
    [SPECIES_MASCOT] = sMascotLevelUpLearnset,
    [SPECIES_MUNCHARLIE] = sMuncharlieLevelUpLearnset,
    [SPECIES_FINGATOR] = sFingatorLevelUpLearnset,
    [SPECIES_GARASITE] = sGarasiteLevelUpLearnset,
    [SPECIES_CUBBLE] = sCubbleLevelUpLearnset,
    [SPECIES_PANDACHOO] = sPandachooLevelUpLearnset,
    [SPECIES_GESUNDHA] = sGesundhaLevelUpLearnset,
    ...
    [SPECIES_ALAKAZAM_MEGA] = sParopeatLevelUpLearnset,
    [SPECIES_SLOWBRO_MEGA] = sParopeatLevelUpLearnset,
    [SPECIES_GENGAR_MEGA] = sParopeatLevelUpLearnset,
    [SPECIES_KANGASKHAN_MEGA] = sParopeatLevelUpLearnset,
    [SPECIES_PINSIR_MEGA] = sParopeatLevelUpLearnset,
    [SPECIES_GYARADOS_MEGA] = sParopeatLevelUpLearnset,
    [SPECIES_AERODACTYL_MEGA] = sParopeatLevelUpLearnset,
    [SPECIES_MEWTWO_MEGA_X] = sParopeatLevelUpLearnset,
    [SPECIES_MEWTWO_MEGA_Y] = sParopeatLevelUpLearnset,
