const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_BURROBIT]              = {{EVO_LEVEL, 25, SPECIES_BUNNAETHER}},
    ...
    [SPECIES_CNIDETER]              = {{EVO_LEVEL, 28, SPECIES_TIDARIA}},
    ...
    [SPECIES_SEAGIRL]               = {{EVO_LEVEL, 25, SPECIES_DOOMERMAID}},
    [SPECIES_BONGSAI]               = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_REEFIR}},
