const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(FONDAUNT_BUSTED, gMonShinyPalette_FondauntBusted),
    ...
    SPECIES_SHINY_PAL(MUNCHARLIE, gMonShinyPalette_Muncharlie),
    SPECIES_SHINY_PAL(FINGATOR, gMonShinyPalette_Fingator),
    SPECIES_SHINY_PAL(GARASITE, gMonShinyPalette_Garasite),
    SPECIES_SHINY_PAL(CUBBLE, gMonShinyPalette_Cubble),
    SPECIES_SHINY_PAL(PANDACHOO, gMonShinyPalette_Pandachoo),
    SPECIES_SHINY_PAL(GESUNDHA, gMonShinyPalette_Gesundha),
