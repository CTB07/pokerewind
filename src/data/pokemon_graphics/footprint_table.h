const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_KRABADICT] = gMonFootprint_Krabadict,
    [SPECIES_KETAGENE] = gMonFootprint_Ketagene,
    [SPECIES_SHORTS] = gMonFootprint_Shorts,
    [SPECIES_PANTS] = gMonFootprint_Pants,
    [SPECIES_CACOBELLE] = gMonFootprint_Cacobelle,
    [SPECIES_DELPHIER] = gMonFootprint_Delphier,
    [SPECIES_KURZEQUAK] = gMonFootprint_Kurzequak,
    ...
    [SPECIES_TELECO] = gMonFootprint_Teleco,
    [SPECIES_ESAKIT] = gMonFootprint_Esakit,
    [SPECIES_FOREKAYE] = gMonFootprint_Forekaye,
    [SPECIES_HELLMO] = gMonFootprint_Hellmo,
    ...
    [SPECIES_INNERLING] = gMonFootprint_Innerling,
    ...
    [SPECIES_ASTLURE] = gMonFootprint_Astlure,
    [SPECIES_HOOTUBE] = gMonFootprint_Hootube,
    [SPECIES_CHANNOWL] = gMonFootprint_Channowl,
    [SPECIES_PUPPARMY] = gMonFootprint_Pupparmy,
    [SPECIES_FANDAM] = gMonFootprint_Fandam,
    [SPECIES_PEWCO] = gMonFootprint_Pewco,
    [SPECIES_PANZERAGE] = gMonFootprint_Panzerage,
    [SPECIES_SQUEEGEE] = gMonFootprint_Squeegee,
    [SPECIES_WHYTEEPEE] = gMonFootprint_Whyteepee,
    [SPECIES_SHIPOSTAR] = gMonFootprint_Shipostar,
    [SPECIES_MUSTELIT] = gMonFootprint_Mustelit,
    [SPECIES_CAPENSEAR] = gMonFootprint_Capensear,
    [SPECIES_SMOGARETTE] = gMonFootprint_Smogarette,
    [SPECIES_METOXIC] = gMonFootprint_Metoxic,
    ...
    [SPECIES_LYSALCHI] = gMonFootprint_Lysalchi,
    [SPECIES_DRACCOON] = gMonFootprint_Draccoon,
    ...
    [SPECIES_DUYUKNO] = gMonFootprint_Duyukno,
    [SPECIES_HALFIST] = gMonFootprint_Halfist,
    [SPECIES_INEVITON] = gMonFootprint_Ineviton,
    [SPECIES_BAYPUP] = gMonFootprint_Baypup,
    [SPECIES_SHARPARENT] = gMonFootprint_Sharparent,
    [SPECIES_SHARPARENT_FEMALE] = gMonFootprint_SharparentF,
    [SPECIES_MEGRANDON] = gMonFootprint_Megrandon,
    [SPECIES_MEGRANDON_FEMALE] = gMonFootprint_MegrandonF,
    [SPECIES_SINDIVIDUA] = gMonFootprint_Sindividua,
    [SPECIES_POWERRUPT] = gMonFootprint_Powerrupt,
    [SPECIES_BROYALTY] = gMonFootprint_Broyalty,
    [SPECIES_PRIMOURN] = gMonFootprint_Primourn,
    [SPECIES_MASCOT] = gMonFootprint_Mascot,
    [SPECIES_MUNCHARLIE] = gMonFootprint_Muncharlie,
    [SPECIES_FINGATOR] = gMonFootprint_Fingator,
    [SPECIES_GARASITE] = gMonFootprint_Garasite,
    [SPECIES_CUBBLE] = gMonFootprint_Cubble,
    [SPECIES_PANDACHOO] = gMonFootprint_Pandachoo,
    [SPECIES_GESUNDHA] = gMonFootprint_Gesundha,
