const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_BUNNAETHER] = gMonFootprint_Bunnaether,
    ...
    [SPECIES_CNIDETER] = gMonFootprint_Cnideter,
    [SPECIES_TIDARIA] = gMonFootprint_Tidaria,
    ...
    [SPECIES_ARTIFISHAL] = gMonFootprint_Artifishal,
    ...
    [SPECIES_SEAGIRL] = gMonFootprint_Seagirl,
    [SPECIES_DOOMERMAID] = gMonFootprint_Doomermaid,
    [SPECIES_BONGSAI] = gMonFootprint_Bongsai,
    [SPECIES_REEFIR] = gMonFootprint_Reefir,
