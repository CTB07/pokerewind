const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(KURZEQUAK, gMonBackPic_Kurzequak),
    ...
    SPECIES_SPRITE(INNERLING, gMonBackPic_Innerling),
    ...
    SPECIES_SPRITE(FONDAUNT, gMonBackPic_Fondaunt),
    SPECIES_SPRITE(FONDAUNT_BUSTED, gMonBackPic_FondauntBusted),
    SPECIES_SPRITE(ROB3R, gMonBackPic_Rob3R),
    ...
    SPECIES_SPRITE(ASTLURE, gMonBackPic_Astlure),
    SPECIES_SPRITE(HOOTUBE, gMonBackPic_Hootube),
    SPECIES_SPRITE(CHANNOWL, gMonBackPic_Channowl),
    SPECIES_SPRITE(PUPPARMY, gMonBackPic_Pupparmy),
    SPECIES_SPRITE(FANDAM, gMonBackPic_Fandam),
    SPECIES_SPRITE(PEWCO, gMonBackPic_Pewco),
    SPECIES_SPRITE(PANZERAGE, gMonBackPic_Panzerage),
    SPECIES_SPRITE(SQUEEGEE, gMonBackPic_Squeegee),
    SPECIES_SPRITE(WHYTEEPEE, gMonBackPic_Whyteepee),
    SPECIES_SPRITE(SHIPOSTAR, gMonBackPic_Shipostar),
    SPECIES_SPRITE(MUSTELIT, gMonBackPic_Mustelit),
    SPECIES_SPRITE(CAPENSEAR, gMonBackPic_Capensear),
    SPECIES_SPRITE(SMOGARETTE, gMonBackPic_Smogarette),
    SPECIES_SPRITE(METOXIC, gMonBackPic_Metoxic),
    ...
    SPECIES_SPRITE(LYSALCHI, gMonBackPic_Lysalchi),
    SPECIES_SPRITE(DRACCOON, gMonBackPic_Draccoon),
    ...
    SPECIES_SPRITE(DUYUKNO, gMonBackPic_Duyukno),
    SPECIES_SPRITE(HALFIST, gMonBackPic_Halfist),
    SPECIES_SPRITE(INEVITON, gMonBackPic_Ineviton),
    SPECIES_SPRITE(BAYPUP, gMonBackPic_Baypup),
    SPECIES_SPRITE(SHARPARENT, gMonBackPic_Sharparent),
    SPECIES_SPRITE(SHARPARENT_FEMALE, gMonBackPic_SharparentF),
    SPECIES_SPRITE(MEGRANDON, gMonBackPic_Megrandon),
    SPECIES_SPRITE(MEGRANDON_FEMALE, gMonBackPic_MegrandonF),
    SPECIES_SPRITE(SINDIVIDUA, gMonBackPic_Sindividua),
    SPECIES_SPRITE(POWERRUPT, gMonBackPic_Powerrupt),
    SPECIES_SPRITE(BROYALTY, gMonBackPic_Broyalty),
    SPECIES_SPRITE(PRIMOURN, gMonBackPic_Primourn),
    SPECIES_SPRITE(MASCOT, gMonBackPic_Mascot),
    SPECIES_SPRITE(MUNCHARLIE, gMonBackPic_Muncharlie),
    SPECIES_SPRITE(FINGATOR, gMonBackPic_Fingator),
    SPECIES_SPRITE(GARASITE, gMonBackPic_Garasite),
    SPECIES_SPRITE(CUBBLE, gMonBackPic_Cubble),
    SPECIES_SPRITE(PANDACHOO, gMonBackPic_Pandachoo),
    SPECIES_SPRITE(GESUNDHA, gMonBackPic_Gesundha),
