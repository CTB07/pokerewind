const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(KURZEQUAK, gMonPalette_Kurzequak),
    ...
    SPECIES_PAL(INNERLING, gMonPalette_Innerling),
    ...
    SPECIES_PAL(FONDAUNT, gMonPalette_Fondaunt),
    SPECIES_PAL(FONDAUNT_BUSTED, gMonPalette_FondauntBusted),
    SPECIES_PAL(ROB3R, gMonPalette_Rob3R),
    ...
    SPECIES_PAL(ASTLURE, gMonPalette_Astlure),
    SPECIES_PAL(HOOTUBE, gMonPalette_Hootube),
    SPECIES_PAL(CHANNOWL, gMonPalette_Channowl),
    SPECIES_PAL(PUPPARMY, gMonPalette_Pupparmy),
    SPECIES_PAL(FANDAM, gMonPalette_Fandam),
    SPECIES_PAL(PEWCO, gMonPalette_Pewco),
    SPECIES_PAL(PANZERAGE, gMonPalette_Panzerage),
    SPECIES_PAL(SQUEEGEE, gMonPalette_Squeegee),
    SPECIES_PAL(WHYTEEPEE, gMonPalette_Whyteepee),
    SPECIES_PAL(SHIPOSTAR, gMonPalette_Shipostar),
    SPECIES_PAL(MUSTELIT, gMonPalette_Mustelit),
    SPECIES_PAL(CAPENSEAR, gMonPalette_Capensear),
    SPECIES_PAL(SMOGARETTE, gMonPalette_Smogarette),
    SPECIES_PAL(METOXIC, gMonPalette_Metoxic),
    ...
    SPECIES_PAL(LYSALCHI, gMonPalette_Lysalchi),
    SPECIES_PAL(DRACCOON, gMonPalette_Draccoon),
    ...
    SPECIES_PAL(DUYUKNO, gMonPalette_Duyukno),
    SPECIES_PAL(HALFIST, gMonPalette_Halfist),
    SPECIES_PAL(INEVITON, gMonPalette_Ineviton),
    SPECIES_PAL(BAYPUP, gMonPalette_Baypup),
    SPECIES_PAL(SHARPARENT, gMonPalette_Sharparent),
    SPECIES_PAL(SHARPARENT_FEMALE, gMonPalette_SharparentF),
    SPECIES_PAL(MEGRANDON, gMonPalette_Megrandon),
    SPECIES_PAL(MEGRANDON_FEMALE, gMonPalette_MegrandonF),
    SPECIES_PAL(SINDIVIDUA, gMonPalette_Sindividua),
    SPECIES_PAL(POWERRUPT, gMonPalette_Powerrupt),
    SPECIES_PAL(BROYALTY, gMonPalette_Broyalty),
    SPECIES_PAL(PRIMOURN, gMonPalette_Primourn),
    SPECIES_PAL(MASCOT, gMonPalette_Mascot),
    SPECIES_PAL(MUNCHARLIE, gMonPalette_Muncharlie),
    SPECIES_PAL(FINGATOR, gMonPalette_Fingator),
    SPECIES_PAL(GARASITE, gMonPalette_Garasite),
    SPECIES_PAL(CUBBLE, gMonPalette_Cubble),
    SPECIES_PAL(PANDACHOO, gMonPalette_Pandachoo),
    SPECIES_PAL(GESUNDHA, gMonPalette_Gesundha),
