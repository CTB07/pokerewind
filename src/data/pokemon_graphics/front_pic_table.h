const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(FONDAUNT_BUSTED, gMonFrontPic_FondauntBusted),
    ...
    SPECIES_SPRITE(MUNCHARLIE, gMonFrontPic_Muncharlie),
    SPECIES_SPRITE(FINGATOR, gMonFrontPic_Fingator),
    SPECIES_SPRITE(GARASITE, gMonFrontPic_Garasite),
    SPECIES_SPRITE(CUBBLE, gMonFrontPic_Cubble),
    SPECIES_SPRITE(PANDACHOO, gMonFrontPic_Pandachoo),
    SPECIES_SPRITE(GESUNDHA, gMonFrontPic_Gesundha),
