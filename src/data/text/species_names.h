const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_FONDAUNT] = _("Fondaunt"),
    [SPECIES_FONDAUNT_BUSTED] = _("Fondaunt"),
    [SPECIES_ROB3R] = _("ROB3R"),
    [SPECIES_SKORCHOP] = _("Skorchop"),
    [SPECIES_CUBEAST] = _("Cubeast"),
    [SPECIES_BEASTUNT] = _("Beastunt"),
    [SPECIES_ASTLURE] = _("Astlure"),
    [SPECIES_HOOTUBE] = _("Hootube"),
    [SPECIES_CHANNOWL] = _("Channowl"),
    [SPECIES_PUPPARMY] = _("Pupparmy"),
    [SPECIES_FANDAM] = _("Fandam"),
    [SPECIES_PEWCO] = _("Pewco"),
    [SPECIES_PANZERAGE] = _("Panzerage"),
    [SPECIES_SQUEEGEE] = _("Squeegee"),
    [SPECIES_WHYTEEPEE] = _("Whyteepee"),
    [SPECIES_SHIPOSTAR] = _("Shipostar"),
    [SPECIES_MUSTELIT] = _("Mustelit"),
    [SPECIES_CAPENSEAR] = _("Capensear"),
    [SPECIES_SMOGARETTE] = _("Smogarette"),
    [SPECIES_METOXIC] = _("Metoxic"),
    [SPECIES_ILLUMARYD] = _("Illumaryd"),
    [SPECIES_ENLIMINATI] = _("Enliminati"),
    [SPECIES_POSTLE] = _("Postle"),
    [SPECIES_HUSHBACK] = _("Hushback"),
    [SPECIES_LYSALCHI] = _("Lysalchi"),
    [SPECIES_DRACCOON] = _("Draccoon"),
    ...
    [SPECIES_DUYUKNO] = _("Duyukno"),
    [SPECIES_HALFIST] = _("Halfist"),
    [SPECIES_INEVITON] = _("Ineviton"),
    [SPECIES_BAYPUP] = _("Baypup"),
    [SPECIES_SHARPARENT] = _("Sharparent"),
    [SPECIES_SHARPARENT_FEMALE] = _("Sharparent"),
    [SPECIES_MEGRANDON] = _("Megrandon"),
    [SPECIES_MEGRANDON_FEMALE] = _("Megrandon"),
    [SPECIES_SINDIVIDUA] = _("Sindividua"),
    [SPECIES_POWERRUPT] = _("Powerrupt"),
    [SPECIES_BROYALTY] = _("Broyalty"),
    [SPECIES_PRIMOURN] = _("Primourn"),
    [SPECIES_MASCOT] = _("Mantichron"),
    [SPECIES_MUNCHARLIE] = _("Muncharlie"),
    [SPECIES_FINGATOR] = _("Fingator"),
    [SPECIES_GARASITE] = _("Garasite"),
    [SPECIES_CUBBLE] = _("Cubble"),
    [SPECIES_PANDACHOO] = _("Pandachoo"),
    [SPECIES_GESUNDHA] = _("Gesundha"),
