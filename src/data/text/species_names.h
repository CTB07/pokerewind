const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_BUNNAETHER] = _("Bunnaether"),
    ...
    [SPECIES_CNIDETER] = _("Cnideter"),
    [SPECIES_TIDARIA] = _("Tidaria"),
    ...
    [SPECIES_ARTIFISHAL] = _("Artifishal"),
    [SPECIES_BINYOTAKE] = _("Binyotake"),
    [SPECIES_SVAMPELETT] = _("Svampelett"),
    [SPECIES_DUGTRIO] = _("Dugtrio"),
    [SPECIES_SEAGIRL] = _("Seagirl"),
    [SPECIES_DOOMERMAID] = _("Doomermaid"),
    [SPECIES_BONGSAI] = _("Bongsai"),
    [SPECIES_REEFIR] = _("Reefir"),
