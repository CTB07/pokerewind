...
const u8 gText_DefaultNameTom[] = _("Harold");
const u8 gText_DefaultNameKenny[] = _("Kappa");
const u8 gText_DefaultNameReid[] = _("Jeff");
const u8 gText_DefaultNameJude[] = _("Pissboy");
const u8 gText_DefaultNameJaxson[] = _("Bichael");
const u8 gText_DefaultNameEaston[] = _("YouTube");
const u8 gText_DefaultNameWalker[] = _("Logan");
const u8 gText_DefaultNameTeru[] = _("s-sir");
const u8 gText_DefaultNameJohnny[] = _("ur mom");
const u8 gText_DefaultNameBrett[] = _("my dude");
const u8 gText_DefaultNameSeth[] = _("A");
const u8 gText_DefaultNameTerry[] = _("DICKS");
const u8 gText_DefaultNameCasey[] = _("Conk");
...
const u8 gText_DefaultNameQuincy[] = _("Walmart");
const u8 gText_DefaultNameKimmy[] = _("Female");
const u8 gText_DefaultNameTiara[] = _("Stacey");
const u8 gText_DefaultNameBella[] = _("Susan");
const u8 gText_DefaultNameJayla[] = _("Bagina");
const u8 gText_DefaultNameAllie[] = _("BestBuy");
const u8 gText_DefaultNameLianna[] = _("Frisk");
const u8 gText_DefaultNameSara[] = _("mommy");
const u8 gText_DefaultNameMonica[] = _("ur mom");
const u8 gText_DefaultNameCamila[] = _("Poki");
const u8 gText_DefaultNameAubree[] = _("nya?");
const u8 gText_DefaultNameRuthie[] = _("gurl");
const u8 gText_DefaultNameHazel[] = _("fucker");
const u8 gText_DefaultNameNadine[] = _("ASS");
const u8 gText_DefaultNameTanja[] = _("▶");
const u8 gText_DefaultNameYasmin[] = _("egg");
const u8 gText_DefaultNameNicola[] = _("Vine");
const u8 gText_DefaultNameLillie[] = _("Vimeo");
const u8 gText_DefaultNameTerra[] = _("ICarly");
const u8 gText_DefaultNameLucy[] = _("Bepsi");
