...
const u32 gBattleAnimSpriteGfx_MouseCursor[] = INCBIN_U32("graphics/battle_anims/sprites/new/horn_hit_2.4bpp.lz");
const u32 gBattleAnimSpritePal_MouseCursor[] = INCBIN_U32("graphics/battle_anims/sprites/new/horn_hit_2.gbapal.lz");
