...
const u16 gSpeciesToNationalPokedexNum[NUM_SPECIES] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
    ...
    SPECIES_TO_NATIONAL(PRIMOURN),
    SPECIES_TO_NATIONAL(MASCOT),
    SPECIES_TO_NATIONAL(MUNCHARLIE),
    SPECIES_TO_NATIONAL(FINGATOR),
    SPECIES_TO_NATIONAL(GARASITE),
    SPECIES_TO_NATIONAL(CUBBLE),
    SPECIES_TO_NATIONAL(PANDACHOO),
    SPECIES_TO_NATIONAL(GESUNDHA),
    ...
    [SPECIES_FONDAUNT_BUSTED - 1] = NATIONAL_DEX_FONDAUNT,
    [SPECIES_DISPUTRAW_SPECIAL - 1] = NATIONAL_DEX_DISPUTRAW,
    [SPECIES_SHARPARENT_FEMALE - 1] = NATIONAL_DEX_SHARPARENT,
    [SPECIES_MEGRANDON_FEMALE - 1] = NATIONAL_DEX_MEGRANDON,
};
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_MACAUMENT- 1] = 0x06,
    [SPECIES_ARGUWINT- 1] = 0x06,
    [SPECIES_PRIMATIO- 1] = 0x06,
    [SPECIES_OPINIMP- 1] = 0x06,
    [SPECIES_TEMPERILLA- 1] = 0x06,
    [SPECIES_SUBSTEE- 1] = 0x06,
    [SPECIES_MANEMBER- 1] = 0x06,
    [SPECIES_TRECHIBER- 1] = 0x06,
    [SPECIES_BULBITE- 1] = 0x06,
    [SPECIES_LAMPUPA- 1] = 0x06,
    [SPECIES_ELECREEP- 1] = 0x06,
    [SPECIES_ACTURUNK- 1] = 0x06,
    [SPECIES_DRAMASPIRE- 1] = 0x06,
    [SPECIES_BURROBIT- 1] = 0x06,
    [SPECIES_RABBITATE- 1] = 0x06,
    [SPECIES_CUCKOOB- 1] = 0x06,
    [SPECIES_TWIDDIES- 1] = 0x06,
    [SPECIES_AIRIOLA- 1] = 0x06,
    [SPECIES_STANDAAD- 1] = 0x06,
    [SPECIES_RECKLOAT- 1] = 0x06,
    [SPECIES_DEVILOAT- 1] = 0x06,
    [SPECIES_KITKAR- 1] = 0x06,
    [SPECIES_CANNEKO- 1] = 0x06,
    [SPECIES_PIKASH- 1] = 0x06,
    [SPECIES_SONIKACHU- 1] = 0x06,
    [SPECIES_GRUBFEED- 1] = 0x06,
    [SPECIES_KWIZBEE- 1] = 0x06,
    [SPECIES_COSMONARCH- 1] = 0x06,
    [SPECIES_PAASTEL- 1] = 0x06,
    [SPECIES_SHEEPASTRY- 1] = 0x06,
    [SPECIES_TYPURR- 1] = 0x06,
    [SPECIES_CALIKEY- 1] = 0x06,
    [SPECIES_SPOOKIDS- 1] = 0x06,
    [SPECIES_TOGETERROR- 1] = 0x06,
    [SPECIES_BUBOZOA- 1] = 0x06,
    [SPECIES_CHRYSAPOD- 1] = 0x06,
    [SPECIES_ARGIGAMI- 1] = 0x06,
    [SPECIES_DISPUTRAW- 1] = 0x06,
    [SPECIES_SPIRICK- 1] = 0x06,
    [SPECIES_PLAGHOST- 1] = 0x06,
    [SPECIES_COVILED- 1] = 0x06,
    [SPECIES_CONTRIP- 1] = 0x06,
    [SPECIES_PLUNGEMENT- 1] = 0x06,
    [SPECIES_ACCIDROP- 1] = 0x06,
    [SPECIES_CURSWORM- 1] = 0x06,
    [SPECIES_WINDOWORM- 1] = 0x06,
    [SPECIES_LOCKSMIAN- 1] = 0x06,
    ...
    [SPECIES_FLEXNAKE- 1] = 0x06,
    [SPECIES_FLEXAIL- 1] = 0x06,
    [SPECIES_ETIKUB- 1] = 0x06,
    [SPECIES_DESMANTHER- 1] = 0x06,
    [SPECIES_SUPPORPOD- 1] = 0x06,
    [SPECIES_FLYPOD- 1] = 0x06,
    [SPECIES_VEESEE- 1] = 0x06,
    [SPECIES_DRACORD- 1] = 0x06,
    [SPECIES_DONKRIME- 1] = 0x06,
    [SPECIES_MAFIADASS- 1] = 0x06,
    [SPECIES_INNERLING- 1] = 0x06,
    [SPECIES_BRAIMATE- 1] = 0x06,
    [SPECIES_CREWEBRAL- 1] = 0x06,
    [SPECIES_IMPVADER- 1] = 0x06,
    [SPECIES_EXTERESSUS- 1] = 0x06,
    [SPECIES_ALSNOW- 1] = 0x06,
    [SPECIES_COOLLEM- 1] = 0x06,
    [SPECIES_DARKORPSE- 1] = 0x06,
    [SPECIES_FUNNESUS- 1] = 0x06,
    [SPECIES_PUPYRO- 1] = 0x06,
    [SPECIES_PYRULPES- 1] = 0x06,
    [SPECIES_KITSINICAL- 1] = 0x06,
    [SPECIES_COMMUNYMPH- 1] = 0x06,
    [SPECIES_MANTIFA- 1] = 0x06,
    [SPECIES_HATCHAAL- 1] = 0x06,
    [SPECIES_CRUSYGLE- 1] = 0x06,
    [SPECIES_BUBBABE- 1] = 0x06,
    [SPECIES_BUBBATH- 1] = 0x06,
    [SPECIES_BUBBLUST- 1] = 0x06,
    [SPECIES_FONDAUNT- 1] = 0x06,
    [SPECIES_ROB3R- 1] = 0x06,
    [SPECIES_SKORCHOP- 1] = 0x06,
    [SPECIES_CUBEAST- 1] = 0x06,
    [SPECIES_BEASTUNT- 1] = 0x06,
    [SPECIES_ASTLURE- 1] = 0x06,
    [SPECIES_HOOTUBE- 1] = 0x06,
    [SPECIES_CHANNOWL- 1] = 0x06,
    [SPECIES_PUPPARMY- 1] = 0x06,
    [SPECIES_FANDAM- 1] = 0x06,
    [SPECIES_PEWCO- 1] = 0x06,
    [SPECIES_PANZERAGE- 1] = 0x06,
    [SPECIES_SQUEEGEE- 1] = 0x06,
    [SPECIES_WHYTEEPEE- 1] = 0x06,
    [SPECIES_SHIPOSTAR- 1] = 0x06,
    [SPECIES_MUSTELIT- 1] = 0x06,
    [SPECIES_CAPENSEAR- 1] = 0x06,
    [SPECIES_SMOGARETTE- 1] = 0x06,
    [SPECIES_METOXIC- 1] = 0x06,
    [SPECIES_ILLUMARYD- 1] = 0x06,
    [SPECIES_ENLIMINATI- 1] = 0x06,
    [SPECIES_POSTLE- 1] = 0x06,
    [SPECIES_HUSHBACK- 1] = 0x06,
    [SPECIES_LYSALCHI- 1] = 0x06,
    [SPECIES_DRACCOON- 1] = 0x06,
    [SPECIES_VEGAVA- 1] = 0x06,
    [SPECIES_GLUTTOCADO- 1] = 0x06,
    [SPECIES_RANDOMAIL- 1] = 0x06,
    [SPECIES_DEDLIVERY- 1] = 0x06,
    [SPECIES_PLAYSTRIKE- 1] = 0x06,
    [SPECIES_EXBULK- 1] = 0x06,
    [SPECIES_TOUCHSPEED- 1] = 0x06,
    [SPECIES_ZOUNO- 1] = 0x06,
    [SPECIES_PHANESIS- 1] = 0x06,
    [SPECIES_BIOSSIL- 1] = 0x06,
    [SPECIES_VIRANCIENT- 1] = 0x06,
    [SPECIES_EVECHO- 1] = 0x06,
    [SPECIES_BARSONIST- 1] = 0x06,
    [SPECIES_CHIPCHUNE- 1] = 0x06,
    [SPECIES_ORCLASSTRA- 1] = 0x06,
    [SPECIES_RELAQUA- 1] = 0x06,
    [SPECIES_SQUEANIME- 1] = 0x06,
    [SPECIES_ENIGMASH- 1] = 0x06,
    [SPECIES_AIRPODON- 1] = 0x06,
    [SPECIES_MIKOMODO- 1] = 0x06,
    [SPECIES_GOJIREC- 1] = 0x06,
    [SPECIES_DUYUKNO- 1] = 0x06,
    [SPECIES_HALFIST- 1] = 0x06,
    [SPECIES_INEVITON- 1] = 0x06,
    [SPECIES_BAYPUP- 1] = 0x06,
    [SPECIES_SHARPARENT- 1] = 0x06,
    [SPECIES_MEGRANDON- 1] = 0x06,
    [SPECIES_SINDIVIDUA- 1] = 0x06,
    [SPECIES_POWERRUPT- 1] = 0x06,
    [SPECIES_BROYALTY- 1] = 0x06,
    [SPECIES_PRIMOURN- 1] = 0x06,
    [SPECIES_MASCOT- 1] = 0x06,
    [SPECIES_MUNCHARLIE- 1] = 0x06,
    [SPECIES_FINGATOR- 1] = 0x06,
    [SPECIES_GARASITE- 1] = 0x06,
    [SPECIES_CUBBLE- 1] = 0x06,
    [SPECIES_PANDACHOO- 1] = 0x06,
    [SPECIES_GESUNDHA- 1] = 0x06,
