...
extern const u32 gMonFrontPic_Bunnaether[];
extern const u32 gMonBackPic_Bunnaether[];
extern const u32 gMonPalette_Bunnaether[];
extern const u32 gMonShinyPalette_Bunnaether[];
extern const u8 gMonIcon_Bunnaether[];
extern const u8 gMonFootprint_Bunnaether[];
...
extern const u32 gMonFrontPic_Artifishal[];
extern const u32 gMonBackPic_Artifishal[];
extern const u32 gMonPalette_Artifishal[];
extern const u32 gMonShinyPalette_Artifishal[];
extern const u8 gMonIcon_Artifishal[];
extern const u8 gMonFootprint_Artifishal[];
...
extern const u32 gMonFrontPic_Seagirl[];
extern const u32 gMonBackPic_Seagirl[];
extern const u32 gMonPalette_Seagirl[];
extern const u32 gMonShinyPalette_Seagirl[];
extern const u8 gMonIcon_Seagirl[];
extern const u8 gMonFootprint_Seagirl[];
extern const u32 gMonFrontPic_Doomermaid[];
extern const u32 gMonBackPic_Doomermaid[];
extern const u32 gMonPalette_Doomermaid[];
extern const u32 gMonShinyPalette_Doomermaid[];
extern const u8 gMonIcon_Doomermaid[];
extern const u8 gMonFootprint_Doomermaid[];
extern const u32 gMonFrontPic_Bongsai[];
extern const u32 gMonBackPic_Bongsai[];
extern const u32 gMonPalette_Bongsai[];
extern const u32 gMonShinyPalette_Bongsai[];
extern const u8 gMonIcon_Bongsai[];
extern const u8 gMonFootprint_Bongsai[];
extern const u32 gMonFrontPic_Reefir[];
extern const u32 gMonBackPic_Reefir[];
extern const u32 gMonPalette_Reefir[];
extern const u32 gMonShinyPalette_Reefir[];
extern const u8 gMonIcon_Reefir[];
extern const u8 gMonFootprint_Reefir[];
